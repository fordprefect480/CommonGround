    ...
    public override async Task HandleAsync(Request req, CancellationToken ct)
    {
        ...
        var rows = await query
            ...
            .Select(a => new
            {
                ...
                ActorFirstName = a.Actor != null ? a.Actor.FirstName : null,
                ActorLastName = a.Actor != null ? a.Actor.LastName : null,
                a.Summary,
                a.TargetType,
                a.TargetId,
                a.DetailsJson,
        ...
        var items = rows
            .Select(r => new ActivityItemDto(
                ...
                ApplicationUser.Compose(r.ActorFirstName, r.ActorLastName),
                r.Summary,
                r.TargetType,
                r.TargetId,
                r.DetailsJson))
